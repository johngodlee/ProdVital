#' Find IDs of individuals which died between two censuses for a single plot
#'
...
#'
#' @return vector of individual ID values for stems which died between censuses
#' 
#' @export
#' 
obsMor <- function(x, ind_id = "stem_id", census_date = "census_date", 
