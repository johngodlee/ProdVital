#' Find IDs of surviving stems between two censuses for a single plot
#'
...
#'
#' @return vector of individual ID values for stems which survived 
#' 
#' @export
#' 
obsSur <- function(x, ind_id = "stem_id", 
